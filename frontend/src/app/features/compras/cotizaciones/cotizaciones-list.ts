...
export class CotizacionesList implements OnInit {
  ...
  // Adjunto (foto o PDF) de la cotización recibida del proveedor.
  ...
  openEdit(cotizacion: Cotizacion): void {
    ...
    this.form.setValue({
      ...
      id_archivo_adjunto: cotizacion.id_archivo_adjunto,
    });
    this.archivoActual.set(cotizacion.archivo_adjunto ?? null);
    this.dialogVisible.set(true);
  }
